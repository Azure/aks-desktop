...
export interface ClusterProviderSliceState {
   ...
   * name and its value is the latest progress message reported for that cluster,
   * or an empty string until a hook reports one. Presence of a cluster name in
   * this map means "preparation in progress" — used to show the connecting popup
   * and suppress the app's "Lost connection" health banner during preparation.
   */
